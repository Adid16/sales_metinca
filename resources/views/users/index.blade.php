        ...
        <div class="card detail-card">
            <div class="card-header bg-primary text-white py-3">
                <h5 class="card-title mb-0">
                    <i class="bi bi-person-workspace"></i> Employee Account 
                </h5>
            </div>    
            ...
            {{-- <div class="card"> --}}
                <div class="card-body py-2">
                    <div class="d-flex justify-content-between align-items-end">
                        <form action="{{ route('users.index') }}" method="GET" class="row g-1 align-items-end w-75 mt-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-auto">
                                ...
                                <a href="{{ route('users.export', $filters ?? []) }}" 
                                    class="btn btn-success btn-sm my-0"><i class="bi bi-file-spreadsheet"></i> Export
                                </a>
                                    ...
                                    <tbody>
                                        @forelse ($users as $user)
                                            <tr>
                                                ...
                                                <td style="width: 50px;"><center>{{ $user->role }} {{ ucfirst($user->divisi) ?? '' }}</center></td>
                                                <td><center>
                                                        <button 
                                                            class="btn btn-sm btn-warning btn-edit" data-user-id="{{ $user->id }}" data-bs-target="#modalEditCustomer" data-bs-toggle="modal"><i
                                                            class="bi bi-pencil-square"></i>
                                                        </button>
                                                        <form action="{{ route('users.destroy', $user->id) }}" method="POST" class="d-inline">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit" onclick="return confirm('Apakah anda yakin ingin menghapus user ini?')" class="btn btn-sm btn-danger"><i class="bi bi-trash-fill"></i></button>
                                                        </form>
                                                </center></td>
                                            </tr>
                                        @empty
