...
@section('content')
<div class="mb-3">
    <h3 class="card-title text-bold">Data Employee</h3>
</div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-end">
                ...
                <button type="submit" class="btn btn-primary my-2" data-bs-toggle="modal" data-bs-target="#modalnewuser">
                    <i class="bi bi-person-plus-fill"></i> Add user
                </button>
                            ...
                            <div class="modal-body">
                                <form action="{{ route('users.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {{-- <input type="text" name="role" value="Customer" class="form-control form-control-sm" id="role"> --}}
        ...
        <table class="table table-hover" id="table1">
            ...
            <tbody>
                <tr>
                    ...
                    <td><center></center></td>
                    <td><center>
                        {{-- INI BUTTON NYA YANG KAYA BUTTON TAMBAH USER 
                        TAPI KAYA UDAH ADA ISINYA GITU KING
                        TRUS YA BERARTI PAS YANG MODAL INI ADA BTN-EDIT KING BARU KEBUKA DEH
                        KAYA YANG PUNYA GUE MENU ACCOUNT DI CUSTOMER  --}}
                        <button class="btn btn-warning btn-sm"
                                type="submit"
                                data-bs-toggle="modal"
                                data-bs-target="#modalnewuser">Kelola akses
                        </button>
                    </center></td>
                </tr>
            </tbody>
