...
<div class="page">
    ...
    <div class="header-left">
        <div style="display: table;">
            <div style="display: table-cell; vertical-align: middle; padding-right: 12px;">
                <img src="{{ public_path('assets/compiled/jpg/logometinca.jpg') }}" 
                     alt="Logo" 
                     style="height: 40px;">
            </div>
    ...
    <div class="header-right">
        ...
        <div class="doc-no">No: <strong>{{ $quotation->quotation_no }}</strong></div>
    </div>
</div>
...
<div class="info-row">
    <div class="info-box" style="width: 40%;">
        ...
        <div class="info-box-body">
            <div class="info-line">
                ...
                <div class="info-value"><strong>{{ $quotation->quotation_no }}</strong></div>
            </div>
            <div class="info-line">
                <div class="info-label">Request ID</div>
                <div class="info-sep">:</div>
                <div class="info-value"><strong>{{ $quotation->request_id ?? '-' }}</strong></div>
            </div>
            <div class="info-line">
                <div class="info-label">Created Date</div>
                <div class="info-sep">:</div>
                <div class="info-value"><strong>{{ \Carbon\Carbon::parse($quotation->created_at)->format('d F Y') }}</strong></div>
            </div>
            <div class="info-line">
                <div class="info-label">Expired Date</div>
                <div class="info-sep">:</div>
                <div class="info-value"><strong>{{ \Carbon\Carbon::parse($quotation->date_expired)->format('d F Y') }}</strong></div>
            </div>
        </div>
    </div>
    <div class="info-box" style="width: 40%; margin-left: 2%;">
        ...
        <div class="info-box-body">
            ...
            <div class="info-line">
                ...
                <div class="info-sep">:</div>
                <div class="info-value">{{ $customerAccount->company ?? '-' }}</div>
            </div>
            <div class="info-line">
                <div class="info-label">Phone</div>
                <div class="info-sep">:</div>
                <div class="info-value">{{ $customerAccount->phone ?? '-' }}</div>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="notes-box">
        ...
        <div class="notes-body">{{ $quotation->notes ?? 'Tidak ada catatan.' }}</div>
    </div>
    ...
    <div class="footer">
        ...
        <div class="footer-right">
            {{ $quotation->quotation_no }} &bull; PT. Metinca Prima Industrial Works
        </div>
    </div>
