                        ...
                        <form action="{{ route('quotations.store') }}" method="POST" id="quotationForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class ="col-md-2">Request Id</div>
                                    <div class="col-md-9 mb-2">
                                        <input type="text" name="request_id" id="idrequest" class="form-control form-control-sm" value="{{ $requestProject->id ?? '' }}" readonly>
                                    </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-2">Customer Id</div>
                                    <div class="col-md-9 mb-2">
                                        <input type="text" name="customer_id" class="form-control form-control-sm" value="{{ $requestProject->customer_id ?? '' }}" readonly>
                                    </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-2">Customer Name</div>
                                    <div class="col-md-9 mb-2">
                                        <input type="text" name="customer_name" id="customerName" class="form-control form-control-sm" value="{{ $requestProject->name ?? '' }}" readonly>
                                    </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 mb-2">
                                    <input type="text" name="customer_company" id="company" class="form-control form-control-sm" value="{{ request('company') ?? ($requestProject->company ?? ($requestProject->customer->company ?? ($customerAccount->company ?? ''))) }}" readonly>
                                </div>  
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-2">Quotation No</div>
                                    <div class="col-md-9 mb-2">
                                        <input type="text" name="quotation_no" id="numberQuotation" class="form-control form-control-sm" value="{{ $quotationNo }}" readonly>
                                    </div>
                            </div>
                            ...
                            <div class="card shadow-sm mb-3 mt-3">
                                ...
                                <div class="card-body p-2">
                                    @if($requestProject && $requestProject->attachments && $requestProject->attachments->count() > 0)
                                            ...
                                            <div class="mb-3 {{ !$loop->last ? 'border-bottom pb-3' : '' }}">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    <span class="fw-semibold" style="font-size:13px">
                                                        ...
                                                        {{ $attachment->document_name ?? basename($attachment->file_path) }}
                                                    </span>
                                                ...
                                                <iframe src="{{ asset('storage/' . $attachment->file_path) }}" width="100%" height="400px" style="border:1px solid #dee2e6; border-radius:4px;"></iframe>
                                            </div>
                                        @endforeach
                                    @else
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 mb-2">
                                    <input type="date" name="target_delivery_date" id="targetDeliveryDate" class="form-control form-control-sm" min="{{ now()->format('Y-m-d') }}">
                                </div>
                            </div>
