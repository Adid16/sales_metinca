                        ...
                        <div class="card-body">
                            <form action ="{{ route('purchase-orders.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 d-flex align-items-between">
                                                <div class="col-md-4">Delivery Request</div>
                                                    <div class="col-md-6 mb-2">
                                                        <input type="date" name="delivery_request" id="deliveryRequest" class="form-control form-control-sm flatpickr-no-config">
                                                    </div>
                                            </div> 
                                        </div>    
                                    ...
                                    {{-- <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="company-column" class="form-control"
                                                placeholder="Company Name" name="company-column">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="email-column">Email</label>
                                            <input type="text" id="email-column" class="form-control" placeholder="email"
                                                name="email-column">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="supplier-id-column">Supplier</label>
                                            <input type="supplier" id="supplier-column" class="form-control"
                                                name="supplier-column" placeholder="Supplier">
                                        </div>
                                    </div> --}}
                                    ...
                                    {{-- <div class="card-content">
                                        ...
                                        <form class="form">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        <label for="contact-column">Contac</label>
                                            <input type="text" id="contact-column" class="form-control"
                                                placeholder="Contact" name="contact-column">
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
