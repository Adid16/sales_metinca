...
<?php $__env->startSection('content'); ?>
    ...
    <section id="horizontal-input">
        <div class="row">
            <div class="col-md-12">
                    <div class="card-body">
                        <form action="<?php echo e(route('quotations.update', $quotation->id)); ?>" method="POST" id="quotationForm"
                                ...
                                <div class="col-md-2">Request Id</div>
                                    <div class="col-md-9 mb-2">
                                        <input type="text" name="request_id" id="idrequest" class="form-control form-control-sm"
                                            value="<?php echo e($quotation->request_id ?? ''); ?>" readonly>
                                    </div>
                            </div>
                                ...
                                <div class="col-md-2">Customer Id</div>
                                    <div class="col-md-9 mb-2">
                                        <input type="text" name="customer_id" class="form-control form-control-sm"
                                            value="<?php echo e($quotation->customer_id ?? ''); ?>" readonly>
                                    </div>
                            </div>
                                ...
                                <div class="col-md-2">Customer Name</div>
                                    <div class="col-md-9 mb-2">
                                        <input type="text" name="customer_name" id="customerName" class="form-control form-control-sm"
                                            value="<?php echo e($quotation->customer->name ?? ''); ?>" readonly>
                                    </div>
                            </div>
                                ...
                                <div class="col-md-2">Company</div>
                                    <div class="col-md-9 mb-2">
                                        <input type="text" name="customer_company" id="company" class="form-control form-control-sm"
                                            value="<?php echo e($quotation->company ?? ($quotation->requestProject->company ?? '')); ?>" readonly>
                                    </div>  
                            </div>
                                ...
                                <div class="col-md-2">Quotation No</div>
                                    <div class="col-md-9 mb-2">
                                        <input type="text" name="quotation_no" id="numberQuotation" class="form-control form-control-sm"
                                            value="<?php echo e($quotation->quotation_no); ?>" readonly>
                                    </div>
                            </div>
                                        ...
                                        <table class="table table-bordered table-sm align-middle mb-2 table-items">
                                            ...
                                            <tbody id="item-container">
                                                <?php $__empty_1 = true; $__currentLoopData = $quotation->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    ...
                                                    ?>
                                                    <tr class="item-row">
                                                        <td class="text-center fw-bold row-num text-muted"><?php echo e($index + 1); ?></td>
                                                        <td>
                                                            ...
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="text" 
                                                                       ...
                                                                       value="<?php echo e($matchedArt ? ($matchedArt->article_no . ' - ' . $matchedArt->part_name) : ''); ?>"
                                                                       placeholder="Cari Article / Part Name..." 
                                                                       autocomplete="off">
                                                            </div>
                                                            <div class="pricelist-badge-container mt-1">
                                                                <?php if($matchedArt): ?>
                                                                    <span class="badge bg-light-success text-success border border-success py-1 px-2" style="font-size: 0.75rem;">
                                                                        <i class="bi bi-check2-circle me-1"></i><strong><?php echo e($matchedArt->article_no); ?></strong> &bull; Rp <?php echo e(number_format($matchedArt->price, 0, ',', '.')); ?>
                                                        ...
                                                        <td>
                                                            <input type="text" name="item[]" class="form-control form-control-sm item-name-input" value="<?php echo e($item->item); ?>" placeholder="Nama item" required>
                                                        </td>
                                                        <td>
                                                            <input type="number" name="qty[]" min="1" class="form-control form-control-sm text-center qty-input" value="<?php echo e($item->qty); ?>" placeholder="Qty" required>
                                                        </td>
                                                        <td>
                                                            <input type="number" name="price[]" step="0.01" min="0" class="form-control form-control-sm text-end price-input" value="<?php echo e((int)$item->price); ?>" placeholder="Harga" required>
                                                        </td>
                                                        <td>
                                                            <input type="text" class="form-control form-control-sm text-end subtotal-cell bg-light fw-semibold" value="Rp <?php echo e(number_format($item->qty * $item->price, 0, ',', '.')); ?>" readonly>
                                                        </td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 mb-2">
                                    <input type="date" name="target_delivery_date" id="targetDeliveryDate" class="form-control form-control-sm"
                                        value="<?php echo e($quotation->target_delivery_date ? \Carbon\Carbon::parse($quotation->target_delivery_date)->format('Y-m-d') : ''); ?>">
                                </div>
                            </div>
                                ...
                                <div class="col-md-2">Date Expired</div>
                                    <div class="col-md-9 mb-2">
                                        <input type="date" required name="date_expired" id="dateExpired" class="form-control form-control-sm flatpickr" 
                                            value="<?php echo e(\Carbon\Carbon::parse($quotation->date_expired ?? $quotation->expired_date)->format('Y-m-d')); ?>">
                                    </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 mb-2">
                                   <select name="payment_terms" id="paymentTerms" class="form-select form-select-sm">
                                        ...
                                        <option value="cash" <?php echo e($quotation->payment_terms === 'cash' ? 'selected' : ''); ?>>Cash</option>
                                        <option value="net_30" <?php echo e($quotation->payment_terms === 'net_30' ? 'selected' : ''); ?>>Net 30</option>
                                        <option value="net_60" <?php echo e($quotation->payment_terms === 'net_60' ? 'selected' : ''); ?>>Net 60</option>
                                        <option value="dp_50" <?php echo e($quotation->payment_terms === 'dp_50' ? 'selected' : ''); ?>>DP 50%</option>
                                        <option value="installment" <?php echo e($quotation->payment_terms === 'installment' ? 'selected' : ''); ?>>Installment</option>
                                        <option value="other" <?php echo e(!in_array($quotation->payment_terms, ['cash', 'net_30', 'net_60', 'dp_50', 'installment', '', null]) ? 'selected' : ''); ?>>Other</option>
                                    </select>
                                    <?php
                                    ...
                                    <input type="text" id="paymentTermsCustom" class="form-control form-control-sm mt-2" 
                                        value="<?php echo e($isCustomTerms ? $quotation->payment_terms : ''); ?>"
                                        placeholder="Tulis payment terms custom, misal: Net 45, DP 30% + Net 60" 
                                        style="display: <?php echo e($isCustomTerms ? 'block' : 'none'); ?>;">
                                    <input type="hidden" name="payment_terms" id="paymentTermsFinal" value="<?php echo e($quotation->payment_terms); ?>">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-2">Notes</div>
                                    <div class="col-md-9 mb-4">
                                        <textarea name="notes" id="notes" cols="30" rows="2" class="form-control form-control-sm"><?php echo e($quotation->notes ?? $quotation->message); ?></textarea>
                                    </div>
                            </div>

                            <a href="<?php echo e(route('quotations.show', $quotation->id)); ?>" class="btn btn-danger btn-sm">Cancel</a>
    ...
    <script>
        ...
        function applyArticleToRow(row, article) {
            ...
            if (article) {
                ...
                priceInput.value = Math.round(article.price) || article.price || 0;
                if (!qtyInput.value || parseFloat(qtyInput.value) <= 0) {
                    qtyInput.value = 1;
                }

                if (badgeContainer) {
                    const priceFormatted = Number(article.price || 0).toLocaleString('id-ID');
                    badgeContainer.innerHTML = `
                        <span class="badge bg-light-success text-success border border-success py-1 px-2" style="font-size: 0.75rem;">
                            <i class="bi bi-check2-circle me-1"></i><strong>${article.article_no || ''}</strong> &bull; Rp ${priceFormatted}
                        </span>
                    `;
                }
            } else {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sales_metinca\resources\views/quotations/edit.blade.php ENDPATH**/ ?>