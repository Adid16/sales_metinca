                                                ...
                                                <?php $__empty_1 = true; $__currentLoopData = $quotation->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    ...
                                                    <tr class="item-row">
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="hidden" name="article_id[]" class="article-id-input" value="<?php echo e($matchedArt?->id ?? ($item->article_id ?? '')); ?>">
                                                            ...
                                                            <div class="pricelist-badge-container mt-1">
                                                                <?php if($matchedArt): ?>
                                                                    <span class="badge bg-light-success text-success border border-success py-1 px-2" style="font-size: 0.75rem;" title="Harga resmi master Price List (Terkunci otomatis)">
                                                                        <i class="bi bi-lock-fill me-1"></i><strong><?php echo e($matchedArt->article_no); ?></strong> &bull; Price List: Rp <?php echo e(number_format($matchedArt->effective_price_list, 0, ',', '.')); ?>
                                                        ...
                                                        <td>
                                                            <input type="number" name="price[]" step="0.01" min="0" class="form-control form-control-sm text-end price-input <?php echo e($matchedArt ? 'bg-light fw-semibold' : ''); ?>" value="<?php echo e((int)$item->price); ?>" placeholder="Harga" <?php echo e($matchedArt ? 'readonly' : ''); ?> required>
                                                        </td>
                                                        <td>
