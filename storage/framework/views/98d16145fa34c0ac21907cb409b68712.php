<?php $__env->startSection('title', 'Negosiasi Quotation - PT. Metinca Prima Industrial Works'); ?>
            ...
            <div class="card stat-card shadow-sm h-100">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <h4 class="mb-0 fw-bold"><?php echo e($allCount); ?></h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card stat-card shadow-sm h-100">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <h4 class="mb-0 fw-bold text-warning"><?php echo e($activeCount); ?></h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card stat-card shadow-sm h-100">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <h4 class="mb-0 fw-bold text-success"><?php echo e($acceptedCount); ?></h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card shadow-sm border" style="border-radius: 12px; overflow: hidden;">
        ...
        <div class="p-3 border-bottom">
            <ul class="nav nav-pills gap-2 flex-wrap" role="tablist">
                <li class="nav-item">
                    <a class="nav-link <?php echo e($tab === 'all' ? 'active bg-primary text-white' : ''); ?>" href="<?php echo e(route('negotiations.index', ['tab' => 'all'])); ?>">
                        <i class="bi bi-grid-fill me-1"></i> Semua Negosiasi 
                        <span class="badge <?php echo e($tab === 'all' ? 'bg-white text-primary' : 'bg-secondary'); ?> ms-1 rounded-pill"><?php echo e($allCount); ?></span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e($tab === 'active' ? 'active bg-warning text-dark' : ''); ?>" href="<?php echo e(route('negotiations.index', ['tab' => 'active'])); ?>">
                        <i class="bi bi-chat-dots me-1 <?php echo e($tab === 'active' ? 'text-dark' : 'text-warning'); ?>"></i> Sedang Berjalan (Active)
                        <span class="badge <?php echo e($tab === 'active' ? 'bg-white text-dark' : 'bg-light-warning text-warning border'); ?> ms-1 rounded-pill"><?php echo e($activeCount); ?></span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e($tab === 'accepted' ? 'active bg-success text-white' : ''); ?>" href="<?php echo e(route('negotiations.index', ['tab' => 'accepted'])); ?>">
                        <i class="bi bi-check-circle-fill me-1 <?php echo e($tab === 'accepted' ? 'text-white' : 'text-success'); ?>"></i> Disepakati / Selesai
                        <span class="badge <?php echo e($tab === 'accepted' ? 'bg-white text-success' : 'bg-light-success text-success border'); ?> ms-1 rounded-pill"><?php echo e($acceptedCount); ?></span>
                    </a>
                </li>
            </ul>
        </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $quotations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $quotation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr>
                                <td class="text-center fw-bold text-muted">
                                    <?php echo e($quotations->firstItem() + $index); ?>

                                </td>
                                <td>
                                    <div class="fw-bold text-primary">
                                        <a href="<?php echo e(route('quotations.show', $quotation->id)); ?>" class="text-decoration-none">
                                            <?php echo e($quotation->quotation_no); ?>

                                        </a>
                                    </div>
                                    <div class="small text-dark fw-semibold">
                                        <i class="bi bi-person-fill text-muted me-1"></i><?php echo e($quotation->customer->name ?? '-'); ?>

                                    </div>
                                    <div class="text-muted" style="font-size: 0.78rem;">
                                        <i class="bi bi-building text-muted me-1"></i><?php echo e($quotation->company ?? ($quotation->customer->company ?? '-')); ?>

                                    </div>
                                </td>
                                <td>
                                    <?php if($lastNego && $lastNego->negotiated_total): ?>
                                        <div class="fw-bold text-dark" style="font-size: 0.92rem;">
                                            Rp <?php echo e(number_format($lastNego->negotiated_total, 0, ',', '.')); ?>

                                        </div>
                                        <small class="text-muted" style="font-size: 0.75rem;">
                                            Dari: <strong><?php echo e($lastNego->from_customer ? 'Customer' : 'Sales'); ?></strong>
                                        </small>
                                    <?php else: ?>
                                        <div class="fw-bold text-dark">
                                            Rp <?php echo e(number_format($quotation->items->sum(fn($i) => $i->price * $i->qty), 0, ',', '.')); ?>
                                ...
                                <td class="text-center">
                                    <span class="badge <?php echo e($quotaExceeded ? 'bg-danger' : 'bg-light-info text-info border border-info'); ?> px-2 py-1" style="font-size: 0.8rem;">
                                        Ke-<?php echo e($currentNegoCount); ?> / <?php echo e($effectiveLimit); ?>x
                                    </span>
                                    <div class="text-muted mt-1" style="font-size: 0.72rem;">
                                        (<?php echo e($maxRounds); ?>x Saling Balas)
                                    </div>
                                </td>
                                <td>
                                    ...
                                    <?php else: ?>
                                        <span class="badge bg-secondary" style="font-size: 0.78rem;"><?php echo e(ucfirst($quotation->status)); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <?php if($lastNego): ?>
                                        <div class="fw-semibold text-dark" style="font-size: 0.8rem;">
                                            <?php echo e($lastNego->created_at->format('d M Y')); ?>

                                        </div>
                                        <small class="text-muted" style="font-size: 0.75rem;">
                                            <?php echo e($lastNego->created_at->format('H:i')); ?> WIB
                                        </small>
                                    <?php else: ?>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo e(route('negotiate.show-nego', $quotation->id)); ?>" class="btn btn-sm btn-primary fw-semibold shadow-sm" title="Buka ruang negosiasi & kelola harga">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sales_metinca\resources\views/negotiations/index.blade.php ENDPATH**/ ?>