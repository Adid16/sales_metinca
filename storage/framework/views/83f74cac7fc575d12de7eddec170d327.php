            ...
            <div class="row">
                <div class="col-md-4 stat-item">
                    <a href="https://maps.app.goo.gl/69gvCEbDPtWCpKD87" target="_blank">
                        <img src="<?php echo e(asset('images/pulo-gadung-foundary.avif')); ?>" class="img-fluid rounded" alt="">
                    </a>
                ...
                <div class="col-md-4 stat-item">
                    <a href="https://maps.app.goo.gl/JRRK87xFATzgG95o6" target="_blank">
                        <img src="<?php echo e(asset('images/tambun-foundary.avif')); ?>" class="img-fluid rounded" alt="">
                    </a>
                ...
                <div class="col-md-4 stat-item">
                    <a href="https://maps.app.goo.gl/T97pYNWGkxmeGneeA" target="_blank">
                        <img src="<?php echo e(asset('images/salatiga-foundary.avif')); ?>" class="img-fluid rounded" alt="">
                    </a>
...
<?php echo $__env->make('layouts.home2', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sales_metinca\resources\views/customer_home/main.blade.php ENDPATH**/ ?>