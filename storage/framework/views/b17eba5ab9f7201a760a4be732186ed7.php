<?php $__env->startSection('title', 'My Account - PT. Metinca Prima Industrial Works'); ?>
...
<div class="card shadow-sm border-0" style="border-radius: 12px;">
    <div class="card-header bg-primary d-flex justify-content-between align-items-center py-3 px-4 rounded-top-3 text-white">
        ...
        <a href="<?php echo e(route('account.edit')); ?>" class="btn btn-warning btn-sm fw-semibold shadow-sm">
    ...
    <div class="card-body px-4 py-4">
        ...
        <?php if(!$account || (!$account->company && !$account->phone && !$account->address)): ?>
            <div class="alert alert-warning d-flex align-items-center gap-2 mb-4">
                ...
                <div>
                    ...
                    <a href="<?php echo e(route('account.edit')); ?>" class="fw-bold text-dark text-decoration-underline ms-1">Lengkapi sekarang →</a>
                </div>
            </div>
        <?php endif; ?>
        ...
        <div class="border rounded p-3 mb-4" style="border-left: 4px solid #435ebe !important;">
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input class="form-control form-control-sm bg-light" value="<?php echo e(Auth::user()->name); ?>" readonly>
                </div>
                <div class="col-md-4">
                    <label class="form-label small fw-bold text-muted">ALAMAT EMAIL</label>
                    <input class="form-control form-control-sm bg-light" value="<?php echo e(Auth::user()->email); ?>" readonly>
                </div>
                <div class="col-md-4">
                    <label class="form-label small fw-bold text-muted">JABATAN / POSISI</label>
                    <input class="form-control form-control-sm bg-light" value="<?php echo e($account->position ?? '-'); ?>" readonly>
                </div>
            </div>
        </div>
        ...
        <div class="border rounded p-3 mb-4" style="border-left: 4px solid #e67e22 !important;">
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input class="form-control form-control-sm bg-light" value="<?php echo e($account->company ?? (Auth::user()->company ?? '-')); ?>" readonly>
                </div>
                <div class="col-md-6">
                    <label class="form-label small fw-bold text-muted">NOMOR TELEPON / WA</label>
                    <input class="form-control form-control-sm bg-light" value="<?php echo e($account->phone ?? '-'); ?>" readonly>
                </div>
                <div class="col-md-6">
                    <label class="form-label small fw-bold text-muted">KOTA</label>
                    <input class="form-control form-control-sm bg-light" value="<?php echo e($account->city ?? '-'); ?>" readonly>
                </div>
                <div class="col-md-6">
                    <label class="form-label small fw-bold text-muted">NOMOR FAX</label>
                    <input class="form-control form-control-sm bg-light" value="<?php echo e($account->fax ?? '-'); ?>" readonly>
                </div>
                <div class="col-md-8">
                    <label class="form-label small fw-bold text-muted">ALAMAT LENGKAP PABRIK / KANTOR</label>
                    <textarea class="form-control form-control-sm bg-light" rows="2" readonly><?php echo e($account->address ?? '-'); ?></textarea>
                </div>
                <div class="col-md-4">
                    <label class="form-label small fw-bold text-muted">KODE POS (ZIP)</label>
                    <input class="form-control form-control-sm bg-light" value="<?php echo e($account->zip ?? '-'); ?>" readonly>
                </div>
            </div>
        </div>
        ...
        <div class="border rounded p-3 mb-4" style="border-left: 4px solid #10b981 !important;">
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                ...
                <a href="<?php echo e(route('account.edit')); ?>" class="btn btn-outline-success btn-sm fw-semibold">
        ...
        <div class="d-flex justify-content-between align-items-center pt-3 border-top text-muted small">
            ...
            <a href="<?php echo e(route('account.edit')); ?>" class="btn btn-primary btn-sm px-3 fw-semibold">
