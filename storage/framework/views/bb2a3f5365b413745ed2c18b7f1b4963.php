<?php $__env->startSection('title', 'Manajemen User - PT. Metinca Prima Industrial Works'); ?>
        ...
        <div class="card shadow-sm border-0" style="border-radius: 12px;">
            <div class="card-header border-0 pb-0 pt-3 px-4 d-flex flex-wrap justify-content-between align-items-center gap-3">
                <div>
                    ...
                    <small class="text-muted">Total <?php echo e($users->count()); ?> akun terdaftar</small>
                </div>
                
                <div class="d-flex flex-wrap align-items-center gap-2">
                    <form action="<?php echo e(route('users.index')); ?>" method="GET" class="d-flex align-items-center gap-2">
                        ...
                        <?php if(request()->filled('role')): ?>
                            <a href="<?php echo e(route('users.index')); ?>" class="btn btn-outline-secondary btn-sm" title="Reset Filter">
                    ...
                    <a href="<?php echo e(route('users.export', $filters ?? [])); ?>" class="btn btn-success btn-sm px-3 shadow-sm">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-initial me-2 shadow-sm" style="background-color: <?php echo e($avatarBg); ?>;">
                                                <?php echo e($initials); ?>

                                            </div>
                                            <div>
                                                <span class="fw-semibold text-body"><?php echo e($user->name); ?></span>
                                    ...
                                    <td>
                                        <span class="text-muted" style="font-size: 0.88rem;"><?php echo e($user->email); ?></span>
                                    </td>
                                    <td class="text-center">
                                        <span class="badge <?php echo e($roleClass); ?> px-2 py-1 rounded" style="font-size: 0.75rem;">
                                    ...
                                    <td class="text-center">
                                        <?php if($user->divisi): ?>
                                            <span class="badge bg-light text-dark border px-2 py-1" style="font-size: 0.75rem;">
                                                <?php echo e(ucwords($user->divisi)); ?>
                                    ...
                                    <td class="text-center">
                                        <span class="badge <?php echo e($plantClass); ?> px-2 py-1 rounded" style="font-size: 0.75rem;">
                                            <i class="bi bi-geo-alt-fill me-1"></i><?php echo e($plant); ?>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm" role="group">
                                            ...
                                            <form action="<?php echo e(route('users.destroy', $user->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus user ini?')">
                                                <?php echo csrf_field(); ?>
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 500px;">
            <div class="modal-content">
                ...
                <div class="modal-body px-4 pt-3 pb-4">
                    <form action="<?php echo e(route('users.store')); ?>" method="POST" id="formCreateUser">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sales_metinca\resources\views/users/index.blade.php ENDPATH**/ ?>