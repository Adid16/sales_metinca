...
<head>
    ...
    <title>LEMBAR TINJAUAN KONTRAK - <?php echo e($contract->contract_number); ?></title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="no-contract text-center">(NO : <?php echo e($contract->contract_no ?? '3701068'); ?>)</div>
        </div>
...
<table class="contract-info">
    <tr>
        ...
        <td width="35%"><?php echo e($contract->customer->name); ?> - <?php echo e($contract->customer->company); ?></td>
        <td width="15%">
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
        ...
        <td width="35%"><?php echo e($contract->created_at ? \Carbon\Carbon::parse($contract->created_at)->format('d - F - Y') : '20 - January - 2025'); ?></td>
    </tr>
    <tr>
        <td width="15%">
            <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <td width="35%"><?php echo e($contract->order_no ?? '6183500'); ?></td>
        <td width="15%">
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
        ...
        <td width="35%"><?php echo e($contract->part_no ?? 'S6-201.04 / 32.441.026 Index d'); ?></td>
    </tr>
    <tr>
    <td width="15%">
        <table width="100%" cellpadding="0" cellspacing="0">
    ...
    <td width="35%">
        <?php echo e($contract->amandement_no ?? '0'); ?> 
        <?php if(!empty($contract->alasan_amandemen)): ?>
            <span style="font-weight: normal; font-style: italic;">(<?php echo e($contract->alasan_amandemen); ?>)</span>
        <?php endif; ?>
    </td>
    <td width="15%">
        <table width="100%" cellpadding="0" cellspacing="0">
    ...
    <td width="35%"><?php echo e($contract->part_name ?? 'Shaft seal casing'); ?></td>
</tr>
    <tr>
        <td width="15%">
            <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <td width="35%"><?php echo e($contract->location ?? 'PT.Metinca (Jakarta)'); ?></td>
        <td width="15%">
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td class="label"></td>
        ...
        <td width="35%"><?php echo e($contract->article_no ?? '344.32.32'); ?></td>
    </tr>
</table>
        ...
        <div class="others-section">
            ...
            <div class="others-content">
                <?php if(isset($contract->others_comment) && $contract->others_comment): ?>
                    <?php echo nl2br(e($contract->others_comment)); ?>
        ...
        <!-- Footer -->
        <div class="footer">
            Printed on <?php echo e(now()->format('d/m/Y H:i:s')); ?> | Lembar Tinjauan Kontrak
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\sales_metinca\resources\views/contracts/pdf.blade.php ENDPATH**/ ?>