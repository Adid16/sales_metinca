            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="/" class="fs-6 d-flex align-items-center gap-2 text-decoration-none">
                                <img src="<?php echo e(asset('assets/compiled/jpg/logometinca.jpg')); ?>" alt="Logo" style="width: 25px; height: auto;">
                    ...
                    <nav class="navbar navbar-expand navbar-light navbar-top px-3 py-2">
                        <div class="container-fluid px-0 d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-3 flex-grow-1 min-w-0">
                                <a href="#" class="burger-btn d-block d-xl-none text-decoration-none" title="Toggle Menu">
                                    <i class="bi bi-justify fs-3"></i>
                                </a>
                                <h4 class="app-page-title mb-0"><?php echo $__env->yieldContent('title'); ?></h4>
                            </div>
                            ...
                            <div class="header-top-right flex-shrink-0 ms-auto">
                                <div class="d-flex align-items-center gap-2 gap-md-3">
                                    ...
                                    <div class="dropdown">
                                        <a class="nav-link active dropdown-toggle text-gray-600 position-relative p-1" href="#"
                                            data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                                            <i class="bi bi-bell bi-sub fs-4"></i>
                                            <?php if(auth()->user()->unreadNotifications->count() > 0): ?>
                                                <span class="badge badge-notification bg-danger position-absolute top-0 start-100 translate-middle">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end notification-dropdown shadow-lg"
                                            ...
                                            <li>
                                                <p class="text-center py-2 mb-0">
                                                    <a href="<?php echo e(route('notifikasi')); ?>" class="small">See all notifications</a>
                                                </p>
                                            </li>
                                        </ul>
                                    </div>
