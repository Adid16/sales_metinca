        ...
        <?php endif; ?>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-end">
                    <form action="<?php echo e(route('users.index')); ?>" method="GET" class="row g-1 align-items-end w-75 mt-2">
                        <div class="col-md-3">
                            ...
                            <select name="role" class="form-select form-select-sm my-0">
                                ...
                                <option value="staff" <?php echo e(request('role') == 'staff' ? 'selected' : ''); ?>>Staff
                                </option>
                    ...
                    <div class="col-md-auto">
                        ...
                        <a href="<?php echo e(route('users.index')); ?>" class="btn btn-danger btn-sm my-0">
                ...
                <a href="<?php echo e(route('users.customers.export', $filters ?? [])); ?>" class="btn btn-success btn-sm my-0"><i
                        ...
                        <tbody style="font-size: 14px;">
                            <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td style="width: 70px;"><?php echo e($user->name); ?></td>
                                    <td><center><?php echo e($user->company); ?></center></td>
                                    <td><center><?php echo e($user->email); ?></center></td>
                                    
                                    <td><center><?php echo e($user->role); ?> <?php echo e(ucfirst($user->divisi) ?? ''); ?></center></td>
                                    <td><center>
                                            <button class="btn btn-sm btn-warning btn-edit" data-user-id="<?php echo e($user->id); ?>" data-bs-toggle="modal" data-bs-target="#modalEditCustomer"><i
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sales_metinca\resources\views/users/index_customer.blade.php ENDPATH**/ ?>