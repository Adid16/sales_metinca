                ...
                <div class="card-body px-4 py-3">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control form-control-sm" id="partNumber" name="part_no" value="<?php echo e($contract->part_no); ?>" readonly>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label class="form-label mb-1 fw-semibold small">ARTICLE</label>
                                ...
                                <input type="text" class="form-control form-control-sm" id="articleInput" placeholder="Ketik kode article lalu tekan enter" value="<?php echo e(old('article_no', $contract->article->article_no ?? '-')); ?>">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card shadow-sm mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            <a href="<?php echo e(route('contracts.index')); ?>" class="btn btn-sm btn-light">Cancel</a>
