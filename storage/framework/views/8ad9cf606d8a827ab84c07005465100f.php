        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('home.main') ? 'active' :''); ?>" href="/home">Home</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('home.products')); ?>">Products</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('home.facilities')); ?>">Facilities</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-target="#metincaAppsModal" data-bs-toggle="modal" href="#"><i
                                class="bi bi-grid-3x3-gap-fill me-2"></i></a>
                    </li>
                </ul>
            </div>
        </div>
...
<?php /**PATH C:\laragon\www\sales_metinca\resources\views/layouts/home.blade.php ENDPATH**/ ?>