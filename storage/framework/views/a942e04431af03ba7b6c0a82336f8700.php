...
unset($__errorArgs, $__bag); ?>"
                                        id="article_no" name="article_no" value="<?php echo e(old('article_no', request('article_no'))); ?>" placeholder="Ketik nomor artikel di sini... (Contoh: ART-BRK-01)" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-5 gap-1 d-flex justify-content-end">
                                ...
                                <a href="<?php echo e(route('articles.index')); ?>" class="btn btn-danger btn-sm"><i class="fas fa-times me-1"></i>Cancel</a>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group mb-0 d-flex align-items-center">
                                    ...
                                    <input type="text" class="form-with-autofill form-control form-control-sm" id="part_number" name="part_number" value="<?php echo e(old('part_number', request('part_number', request('part_no')))); ?>">
                                </div>
                            </div>  
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group mb-0 d-flex align-items-center">
                                    ...
                                    <input type="text" class="form-with-autofill form-control form-control-sm" id="part_name" name="part_name" value="<?php echo e(old('part_name', request('part_name', request('item')))); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group mb-0 d-flex align-items-center">
                                    ...
                                    <input type="text" class="form-with-autofill form-control form-control-sm" id="index_no" name="index_no" value="<?php echo e(old('index_no', request('index_no'))); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group mb-0 d-flex align-items-center">
                                    ...
                                    <input type="number" step="0.01" class="form-with-autofill form-control form-control-sm" id="berat" name="berat" value="<?php echo e(old('berat', request('berat'))); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group mb-0 d-flex align-items-center">
                                    ...
                                    <input type="text" class="form-with-autofill form-control form-control-sm" id="die_no" name="die_no" value="<?php echo e(old('die_no', request('die_no'))); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group mb-0 d-flex align-items-center">
                                    ...
                                    <input type="text" class="form-with-autofill form-control form-control-sm" id="material" name="material" value="<?php echo e(old('material', request('material'))); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group mb-0 d-flex align-items-center">
                                    ...
                                    <input type="text" class="form-with-autofill form-control form-control-sm" id="drawing_no" name="drawing_no" value="<?php echo e(old('drawing_no', request('drawing_no'))); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group mb-0 d-flex align-items-center">
                                    ...
                                    <input type="text" class="form-with-autofill form-control form-control-sm" id="drawing_rev" name="drawing_rev" value="<?php echo e(old('drawing_rev', request('drawing_rev'))); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group mb-0 d-flex align-items-center">
                                    ...
                                    <input type="date" class="form-with-autofill form-control form-control-sm" id="effective_date" name="effective_date" value="<?php echo e(old('effective_date', date('Y-m-d'))); ?>">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group mb-0 d-flex align-items-center">
                                    ...
                                    <select class="form-select form-select-sm" id="customer_id" name="customer_id">
                                        ...
                                        <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cust): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($cust->id); ?>" <?php echo e(old('customer_id', request('customer_id')) == $cust->id ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-7">
                                <div class="form-group mb-0 d-flex align-items-center">
                                    ...
                                    <select class="form-select form-select-sm" id="lokasi_pengerjaan" name="lokasi_pengerjaan">
                                        <option value="1" <?php echo e(old('lokasi_pengerjaan', 1) == 1 ? 'selected' : ''); ?>>PT. Metinca (Jakarta)</option>
                                        <option value="2" <?php echo e(old('lokasi_pengerjaan') == 2 ? 'selected' : ''); ?>>PT. Metal Castindo</option>
                                        <option value="3" <?php echo e(old('lokasi_pengerjaan') == 3 ? 'selected' : ''); ?>>PT. Metinca S3</option>
                                        <option value="4" <?php echo e(old('lokasi_pengerjaan') == 4 ? 'selected' : ''); ?>>Valve</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group mb-0 d-flex align-items-start">
                                    ...
                                    <textarea class="form-with-autofill form-control form-control-sm" id="remark" name="remark" rows="2" placeholder="Catatan tambahan..."><?php echo e(old('remark', request('remark'))); ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group mb-1 d-flex align-items-center">
                                    ...
                                    <input type="number" id="casting_price" name="casting_price" class="form-control form-control-sm font-weight-bold" value="<?php echo e($defaultCasting); ?>" required>
                                </div>  
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group mb-1 d-flex align-items-center">
                                    ...
                                    <input type="number" id="machining_price" name="machining_price" class="form-control form-control-sm font-weight-bold" value="<?php echo e($defaultMachining); ?>" required>
                                </div>  
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group mb-2 d-flex align-items-center">
                                    ...
                                    <input type="number" id="total_price" name="price" class="form-control form-control-sm bg-light font-weight-bold text-success border-success" value="<?php echo e($defaultPrice); ?>" readonly>
                                </div>  
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sales_metinca\resources\views/articles/create.blade.php ENDPATH**/ ?>