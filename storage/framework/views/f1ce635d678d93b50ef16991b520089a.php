...
<div class="modal-body px-4 pt-3 pb-4">
    <form action="<?php echo e(route('users.update', $user->id)); ?>" method="POST" id="formEditCustomer_<?php echo e($user->id); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" class="form-control" id="customername"
                placeholder="Name" value="<?php echo e(old('name', $user->name)); ?>" required>
        </div>

        <div class="mb-3">
            <label class="form-label text-uppercase fw-bold" style="font-size: 0.72rem; letter-spacing: 0.5px; color: #8e9bb0;">Company</label>
            <input type="text" name="company" value="<?php echo e(old('company', $user->company)); ?>" class="form-control" id="companyname"
                placeholder="Company">
        </div>

        <div class="mb-3">
            <label class="form-label text-uppercase fw-bold" style="font-size: 0.72rem; letter-spacing: 0.5px; color: #8e9bb0;">Email</label>
            <input type="email" name="email" value="<?php echo e(old('email', $user->email)); ?>" class="form-control" id="email"
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                <input type="password" name="password" id="custEditPassword_<?php echo e($user->id); ?>" class="form-control"
                    placeholder="Masukkan password baru (min. 6 karakter)">
                <button type="button" class="btn btn-outline-secondary" onclick="togglePasswordVisibility('custEditPassword_<?php echo e($user->id); ?>', this)" title="Lihat/Sembunyikan Password">
                    <i class="bi bi-eye"></i>
                </button>
            </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                <input type="password" name="password_confirmation" id="custEditPasswordConfirm_<?php echo e($user->id); ?>" class="form-control"
                    placeholder="Ulangi password baru">
                <button type="button" class="btn btn-outline-secondary" onclick="togglePasswordVisibility('custEditPasswordConfirm_<?php echo e($user->id); ?>', this)" title="Lihat/Sembunyikan Password">
                    <i class="bi bi-eye"></i>
                </button>
            </div>
        </div>
...
document.getElementById('formEditCustomer_<?php echo e($user->id); ?>').addEventListener('submit', function(e) {
    const pass = document.getElementById('custEditPassword_<?php echo e($user->id); ?>').value;
    const confirm = document.getElementById('custEditPasswordConfirm_<?php echo e($user->id); ?>').value;
    if (pass) {
        if (pass.length < 6) {
            e.preventDefault();
...
<?php /**PATH C:\laragon\www\sales_metinca\resources\views/users/customer-edit-partial.blade.php ENDPATH**/ ?>